                ...
                <div class="container-fluid">
                    <div class="header-left">
                        <ul class="top-menu top-link-menu">
                            <li><a href="tel:#" class="link-phone"><i class="fas fa-phone"></i>(62) 8958867</a></li>
                            <li><a href="#" class="link-email"><i class="fas fa-envelope-open"></i>alifharesta@gmail.com</a></li>
                        </ul>
                    </div>
